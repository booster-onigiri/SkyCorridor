...
def main():
    ...
    if a.kind == 'assets':
        ...
        for i, group in enumerate(groups, 1):
            name = f'SkyCorridor-v0.1.0-DevelopmentAssets-{i:02}.zip'
            result.append(archive(a.output/name, group, ROOT))
        for entry in result:
            entry['url'] = 'https://github.com/booster-onigiri/SkyCorridor/releases/download/v0.1.0/' + entry['name']
        ...
        result.append(archive(a.output/'SkyCorridor-v0.1.0-Source.zip', selected, ROOT))
    else:
        ...
        result.append(archive(a.output/'SkyCorridor-v0.1.0-Windows.zip', receipt['files'], a.windows_root))
